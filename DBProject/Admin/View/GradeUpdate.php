...
include_once '../control/gradeupdatecheck.php'; ?>
...
<body background="../file/s1.jpg">
    <h3> <a href="../view/gradeUpdateHistory.php">Tap to See the Update History </a> <br>
                                    ...
                                    <tr>
                                        <td>
                                            <form action="" method="post">
                                                <p class="p3" id="labels"> Employee ID :
                                                    <input type="number" name="e_id" id="e_id"
                                                        placeholder="Type Employee ID" required>
