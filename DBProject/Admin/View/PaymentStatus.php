...
<body>
    <form action="" method="post"><br>
        Highest Amount Paid by - <input type="submit" class="button searchbutton" name="search" value="Search"><br><br>
...
<?php include '../control/PaymentStatusCheck.php'; ?>